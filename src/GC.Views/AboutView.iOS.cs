...
public static class AboutViewIOS
{
    ...
    public static Control Create(MainViewModel viewModel)
    {
        ...
        contentPanel.Children.Add(new TextBlock
        {
            Text = "Icons erstellt von:",
            FontSize = 14,
            FontWeight = FontWeight.SemiBold,
            Foreground = GetTextBrush()
        });

        var iconAuthorsStack = new StackPanel { Spacing = 4 };
        iconAuthorsStack.Children.Add(MakeLinkButton("Freepik", 14));
        iconAuthorsStack.Children.Add(new TextBlock
        {
            Text = "von",
            FontSize = 12,
            Foreground = GetSecondaryTextBrush()
        });
        iconAuthorsStack.Children.Add(MakeLinkButton("www.flaticon.com", 14));
        contentPanel.Children.Add(iconAuthorsStack);
