...
public static class HttpClientHelper
{
...
#if IOS || MACCATALYST
        // iOS/Mac Catalyst doesn't support disabling system proxy or custom proxy settings
        // Just use the default handler with cookie container
    ...
    {
#if IOS || MACCATALYST
        // iOS/Mac Catalyst doesn't support custom proxy handling
        return false;
#else
        WebProxy? proxy = GetProxy(requestUrl);
        if (proxy is null)
